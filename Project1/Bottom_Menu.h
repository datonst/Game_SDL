...
namespace Crash {
	...
	bool Crash_Object(SDL_Window* g_window, SDL_Renderer* g_renderer, SDL_Texture* background, MainO& human,Map& ga_map, Explosion& exp, std::vector<threatObject*>& list_bear);
}
#endif // BOTTOM_MENU_
